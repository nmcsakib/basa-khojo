...
const ProductCard = () => {
    ...
    return (
        <div className="md:w-full w-11/12 mx-auto shadow-lg dark:bg-slate-800 bg-white rounded-2xl">
            ...
            <div className="flex w-full justify-between items-center p-4">
                <div className="flex  items-center gap-4">
                    <div className=" flex flex-col">
                        <h2 className="font-semibold dark:text-[#abc2d3] text-2xl">Sublet Room Rent</h2>
                        <p className="text-sm text-gray-200">Santhos, Tangail</p>
                    </div>
                </div>
            </div>
